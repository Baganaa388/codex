      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <div className="space-y-8 animate-in slide-in-from-left-8 duration-700">
          ...
          <div className="relative h-64 rounded-3xl overflow-hidden glass border border-white/10 group">
            <div className="absolute inset-0 bg-[linear-gradient(rgba(237,175,0,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(47,85,190,0.06)_1px,transparent_1px)] bg-[size:20px_20px]"></div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative">
                <div className="w-8 h-8 bg-[#EDAF00] rounded-full animate-ping absolute opacity-50"></div>
                <div className="w-8 h-8 bg-[#EDAF00] rounded-full flex items-center justify-center relative">
